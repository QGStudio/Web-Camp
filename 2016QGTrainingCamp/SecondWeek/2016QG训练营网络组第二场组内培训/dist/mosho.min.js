(function() {
    "use strict";
    var Camera, SceneElement, Slide, SlideGroup, addDocListener, addWinListener, attachPlugin, camera, css, defTransform, fireDocEvent, init, initListeners, initialized, memoize1, mosho, onEnterSlide, onLeaveSlide, perspective, pfx, root, transform3d, transformData, unHash, updateWinHash, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
        function ctor() {
    ...
    fireDocEvent = function(evtName, detail) {
        ...
        evt.initCustomEvent(evtName, !0, !0, detail),
    ...
    pfx = function() {
        var pres, style;
        return style = document.createElement("dummy").style,
        pres = ["Webkit", "Moz", "O", "ms", "Khtml"],
        memoize1(function(prop) {
    ...
    transform3d = function(_arg, rev) {
        var r, s, t;
        return t = _arg.translate,
        r = _arg.rotate,
        s = _arg.scale,
        rev == null  && (rev = !1),
        rev ? "scale(" + 1 / s + ")" + (" rotateZ(" + -r.z + "deg) rotateY(" + -r.y + "deg) rotateX(" + -r.x + "deg)") + (" translate3d(" + -t.x + "px," + -t.y + "px," + -t.z + "px)") : "translate3d(" + t.x + "px," + t.y + "px," + t.z + "px)" + (" rotateX(" + r.x + "deg) rotateY(" + r.y + "deg) rotateZ(" + r.z + "deg)") + (" scale(" + s + ")")
    }
    ,
    transformData = function(data, def) {
        var transform;
        return def == null  && (def = defTransform),
        transform = {
    ...
    SceneElement = function() {
        function SceneElement(el, parent) {
            ...
            this.el.id || (this.el.id = "mosho-element-" + n),
            this.id = this.el.id,
            css(this.el, {
                position: "absolute",
                display: "block",
        ...
        SceneElement.prototype.show = function(t) {
            ...
            typeof t == "string" && (e = this.getById(t)) != null  ? e.show() : !1
        }
        ,
        ...
        SceneElement.prototype.getTransformList = function() {
            var transforms, _ref;
            return transforms = [this.transform].concat(((_ref = this.parent) != null  ? _ref.getTransformList() : void 0) || []),
            transforms
        }
        ,
        ...
        SceneElement.prototype.buildCssTransform = function(camera) {
            ...
            transform3d(this.buildTotalTransform(), camera)
        }
        ,
        ...
        SceneElement.prototype.scale = function(s, abs) {
            s == null  && (s = 1),
            abs == null  && (abs = !1),
            abs ? this.transform.scale = s : this.transform.scale *= s,
            this.updateCss()
        }
        ,
        SceneElement
        ...
        function SlideGroup(el, parent) {
            ...
            this.children = function() {
                ...
                _len = _ref.length; _i < _len; _i++)
                    el = _ref[_i],
                    (el != null  ? (_ref1 = el.classList) != null  ? _ref1.contains("mosho-slide") : void 0 : void 0) ? _results.push(new Slide(el,me)) : (el != null  ? (_ref2 = el.classList) != null  ? _ref2.contains("mosho-group") : void 0 : void 0) ? _results.push(new SlideGroup(el,me)) : _results.push(void 0);
                return _results
            }
            .call(this)
        }
        return __extends(SlideGroup, _super),
        SlideGroup.prototype.updateCss = function() {}
        ,
        SlideGroup.prototype.show = function(t) {
            return SlideGroup.__super__.show.call(this, t) ? !0 : this.getByOrder(1, !0).show()
        }
        ,
        SlideGroup
    }(SceneElement),
    Camera = function(_super) {
        ...
        return __extends(Camera, _super),
    ...
    Slide = function(_super) {
        ...
        var active, n, slides;
        return __extends(Slide, _super),
        active = null ,
        slides = [],
        n = 0,
        Slide.prototype.show = function(t) {
            var prevSlide;
            return Slide.__super__.show.call(this, t) ? !0 : this === this.getActiveSlide() ? !0 : (prevSlide = this.getActiveSlide(),
            fireDocEvent("mosho:enter:" + this.id),
            prevSlide != null  && fireDocEvent("mosho:leave:" + prevSlide.id),
            ...
            prevSlide != null  && prevSlide.el.classList.remove("mosho-active"),
            prevSlide != null  && prevSlide.el.classList.add("mosho-inactive"),
            this.el.classList.remove("mosho-inactive"),
            this.el.classList.add("mosho-active"),
            css(camera.el, {
                transform: this.buildCssTransform(!0),
        ...
        Slide.prototype.getPrevSlide = function() {
            return this.data.prev != null  ? this.getById(this.data.prev) : slides[this.slidesOrder === 0 ? slides.length - 1 : this.slidesOrder - 1]
        }
        ,
        Slide.prototype.getNextSlide = function() {
            return this.data.next != null  ? this.getById(this.data.next) : slides[this.slidesOrder === slides.length - 1 ? 0 : this.slidesOrder + 1]
        }
        ,
    ...
    init = function() {
        ...
        camera.show(unHash(window.location.hash)) || camera.getByOrder(0).show(),
        initListeners(),
        initialized = !0,
    ...
    attachPlugin = function(plug) {
        var _ref;
        (_ref = plug.name) == null  && (plug.name = "Anonymous Plugin"),
        initialized && console.warn("plugin '" + plug.name + "' attached after Mosho.init()"),
        typeof plug.preJump == "function" && addDocListener("mosho:pre-init", plug.preinit),
        typeof plug.postInit == "function" && addDocListener("mosho:post-init", plug.postInit),
        typeof plug.preShow == "function" && addDocListener("mosho:pre-show", plug.preShow),
        typeof plug.postShow == "function" && addDocListener("mosho:post-show", plug.postShow)
    }
    ,
    mosho = window.mosho = {
        init: init,
        ...
        getElement: function(id) {
            return id != null  ? SceneElement.prototype.getById(id) : Slide.prototype.getActiveSlide()
        },
        enter: onEnterSlide,
        leave: onLeaveSlide,
        plugin: attachPlugin
